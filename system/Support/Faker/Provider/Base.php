...
use LengthException;
use System\Support\Faker\Generator;
use System\Support\Faker\DefaultGenerator;
use System\Support\Faker\UniqueGenerator;
...
class Base
{
    ...
    public static function randomElements(array $array = ['a', 'b', 'c'], $count = 1)
    {
        ...
        if ($numKeys < $count) {
            throw new LengthException("Cannot get {$count} elements, only {numKeys} in array");
        }
