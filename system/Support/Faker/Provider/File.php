...
class File extends Base
{
    ...
    {
        $randomExtension = static::randomElement(array_values(static::$mimeTypes));
        return is_array($randomExtension) ? static::randomElement($randomExtension) : $randomExtension;
    }
    ...
    public static function file($sourceDirectory = '/tmp', $targetDirectory = '/tmp', $fullPath = true)
    {
        if (!is_dir($sourceDirectory)) {
            throw new InvalidArgumentException(
                'Source directory %s does not exist or is not a directory: '.$sourceDirectory
            );
        }

        if (!is_dir($targetDirectory)) {
            throw new InvalidArgumentException(
                'Target directory %s does not exist or is not a directory: '.$targetDirectory
            );
        }
        ...
        if (empty($files)) {
            throw new InvalidArgumentException('Source directory is empty: '.$sourceDirectory);
        }
