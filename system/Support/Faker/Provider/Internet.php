...
class Internet extends Base
{
    ...
    public function email()
    {
        ...
        return strtolower($this->generator->parse($format));
    }


    final public function safeEmail()
    {
        return strtolower(preg_replace('/\s/u', '', $this->userName().'@'.static::safeEmailDomain()));
    }


    public function freeEmail()
    {
        return strtolower(preg_replace('/\s/u', '', $this->userName().'@'.static::freeEmailDomain()));
    }


    public function companyEmail()
    {
        return strtolower(preg_replace('/\s/u', '', $this->userName().'@'.$this->domainName()));
    }


    public static function freeEmailDomain()
    {
        return strtolower(static::randomElement(static::$freeEmailDomain));
    }
    ...
    final public static function safeEmailDomain()
    {
        ...
        return strtolower(static::randomElement($domains));
    }
