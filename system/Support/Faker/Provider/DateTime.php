...
class DateTime extends Base
{
    ...
    {
        return new PhpDateTime('@'.static::unixTime($max));
    }


    public static function dateTimeAD($max = 'now')
    {
        return new PhpDateTime('@'.mt_rand(-62135597361, static::getMaxTimestamp($max)));
    }


    public static function iso8601($max = 'now')
    {
        return static::date(PhpDateTime::ISO8601, $max);
    }
    ...
    {
        $startTimestamp = ($startDate instanceof PhpDateTime)
