...
class UserAgent extends Base
{
    ...
    public static function chrome()
    {
        ...
        $platforms = [
            '('.static::linuxPlatformToken().") AppleWebKit/$saf (KHTML, like Gecko) Chrome/".mt_rand(36, 70).'.0.'.mt_rand(800, 899).".0 Mobile Safari/$saf",
            '('.static::windowsPlatformToken().") AppleWebKit/$saf (KHTML, like Gecko) Chrome/".mt_rand(36, 70).'.0.'.mt_rand(800, 899).".0 Mobile Safari/$saf",
            '('.static::macPlatformToken().") AppleWebKit/$saf (KHTML, like Gecko) Chrome/".mt_rand(36, 70).'.0.'.mt_rand(800, 899).".0 Mobile Safari/$saf",
        ];
    ...
    {
        $ver = 'Gecko/'.date('Ymd', mt_rand(strtotime('2010-1-1'), time())).' Firefox/'.mt_rand(35, 60).'.0';
        $platforms = [
